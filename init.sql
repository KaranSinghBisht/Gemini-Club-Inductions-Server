...
INSERT INTO users (username, password, role, domain, mentee_capacity) VALUES
('DAdmin', 'password123', 'core', NULL, NULL),
('john_mentor', 'password123', 'mentor', 'web', 5),
('jane_mentee', 'password123', 'mentee', NULL, NULL);
